        ...
        <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-8 lg:col-start-3">
          <div className="bg-white rounded-xl p-8 md:p-12 mt-8 text-center shadow-lg border border-[#6F4C21]/10">
            ...
            <p className="text-[#6F4C21]/80 mb-8 max-w-2xl mx-auto">
              Si deseás obtener más información sobre nuestras experiencias, fechas disponibles
              o querés organizar un retiro personalizado, no dudes en contactarnos.
            </p>
            
            <button
              onClick={handleWhatsAppClick}
              className="inline-flex justify-center items-center py-3 px-8 bg-green-600 hover:bg-green-700 rounded-lg shadow-sm text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
            >
              <svg 
