      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4 pt-4">
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 px-6 text-lg font-semibold text-white bg-earth-brown hover:bg-earth-brown/90 focus:outline-none focus:ring-4 focus:ring-earth-brown/30 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            {isLoading ? (
